 ...
 */
namespace Plazathemes\Template\Block\Adminhtml\Template\Edit\Tab;
...
class Template extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'label' => __('Chose Action'),
                'title' => __('Chose Action'),
                'name' => 'template',
                'required' => true,
                'options' => [1 => __('Install Template'), 2 => __('Uninstall Template')]
            ]
        );
