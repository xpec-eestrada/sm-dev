...
class CateWidget extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Widget\Block\BlockInterface
{
    ...
    public function getProductsExceptFirst($id) {
        $_productCollection=$this->getProductCate($id);
        $_firstProduct = $this->getFirstProductInCollection($id);
        
        $_finalCollection = array();
        foreach($_productCollection as $_product) {
            if($_product->getId() == $_firstProduct->getId()) continue;
            array_push($_finalCollection, $_product);
        }
        
        return $_finalCollection;
    }

    public function getFirstProductInCollection($id) {
        $_productCollection =$this->getProductCate($id);
    ...
    public function getCateStaticBlock()
    {
