...
/* function __construct($url='https://webpay3gint.transbank.cl/WSWebpayTransaction/cxf/WSWebpayService?wsdl')
 {
    ...
    try{
        ...
        throw new Exception('Dentro de WEb - '.$err->getMessage());
    }
...
function getTransactionResult(getTransactionResult $getTransactionResult)
{
...
function acknowledgeTransaction(acknowledgeTransaction $acknowledgeTransaction)
{
...
function initTransaction(initTransaction $initTransaction)
{
